...
export default function Footer() {
    return (
        <div>
            <div className="bg-[#2D5D90] mt-4 text-white p-7 w-full sm:block hidden">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div className='pt-1 pb-1 flex gap-2'>
                                <Image src={icon.facebook} alt='facebook'className='w-14' />
                                <Image src={icon.messenger} alt='message'className='w-14' />
                                <Image src={icon.youtube} alt='youtube'className='w-14' />
                            </div>
                        </div>
                    </div>
                    <div>
            ...
            <div className="sm:hidden block w-full fixed bottom-0 style_mobile_navBar">
                <NavBarMobile/>
            </div>
        </div>
    )
